...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx15cf60a334db82f1',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'de3c484437e3a8eeef7bd96d04a744ee',
  ...
  USERS: [
    {
      ...
      id: 'oDoGd530oui0zWknRLhkWO75rVtA',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'tjzwJUpaPGttzjvWFnyqBtDJMOzN1efQJnTEEFUhwHs',
      // 所在省份
      province: '北京',
      // 所在城市
      city: '房山',
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2021-08-25' },
        ...
        courses: {
          ...
          odd: [
            ...
            [
              ...
              '13:30-14:10 体育',
              '14:20-15:00 体育',
              '15:10-15:50 思想道德修养与法律基础',
              '16:00-16:40 思想道德修养与法律基础',
              '16:50-17:30 思想道德修养与法律基础'
            ],
            // 周四
            [
              '09:40-10:20 边弹边唱',
              '10:40-11:20 声乐基础',
              '11:30-12:10 幼儿舞蹈基础',
              '13:30-14:10 大学生心理适应与发展',
              '14:20-15:00 大学生心理适应与发展',
              '15:10-15:50 大学生学业规划与发展',
              '16:00-16:40 大学生学业规划与发展'
            ],
            // 周五
            [
              '10:40-11:20 大学语文',
  ...
  CALLBACK_TEMPLATE_ID: 'oDoGd56mLLw8k0DVojPXHH7JVTyM',
